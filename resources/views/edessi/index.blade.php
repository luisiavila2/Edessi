...
{{--         <header class="masthead">
            <div class="container">
                <div class="masthead-heading text-clip">EDESSI!!!</div>
                <div class="masthead-subheading">Una empresa de desarrollo de software y sericios informáticos</div>
                <a class="p-2 pl-5 pr-5 bg-gray-500 text-gray-100 text-lg rounded-lg focus:border-4 border-gray-300" href="#services">Nuestros Servicios</a>
            ...
            <div class="container">
                ...
                <div class="p-4 gap-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 select-none">
                        ...
                        @foreach ($service as $services)
                            <a href="{{route('form.show', $services->id)}}">
                                <div class="w-full cursor-pointer rounded-md shadow-md shadow-gray-200 hover:shadow-blue-400/80 hover:shadow-2xl hover:bg-gray-50">
                                    <img class="aspect-video bg-cover w-full rounded-t-md min-h-40" src="{{$services->img}}" />
                                    <div class="p-4">
                                        <p class="font-semibold text-xl py-2">{{$services->nombre}}</p>
                                        <p class="font-light text-gray-700 text-justify line-clamp-3">{{Str::limit($services->descripcion, 300)}}</p>
                                    </div>
                                </div>
                            </a>
                        @endforeach
