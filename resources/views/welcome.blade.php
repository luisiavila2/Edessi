...
<html lang="es">
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#about">Noticias</a></li>
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-heading text-clip">Bienvenidos a EDESSI!!!</div>
                <div class="masthead-subheading">Una empresa de desarrollo de software y sericios informáticos</div>
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">
                        Edessi es una empresa especializada en el desarrollo de aplicaciones web y servicios informáticos. Contamos con una amplia experiencia en el sector y un equipo de trabajo multidisciplinario formado por especialistas de las ciencias informáticas. Garantizamos proveer un servicio de calidad que ayudarán de manera significativa a solucionar los problemas por los que pueda estar cruzando su empresa en el área de la informática ahorrándole tiempo y dinero.
                    </h3>
                </div>
                    <div class="text-justify">
                        <h3 class="section-subheading text-muted">
                            <strong>¿Qué servicios ofrecemos?</strong>
                            <ul>
                                <li>Edessi ofrece una amplia variedad  servicios:</li>
                                <li>Desarrollo de Software y sistemas informáticos.</li>
                                <li>Diseño gráfico y entorno visual.</li>
                                <li>Soporte técnico.</li>
                                <li>Asesoramiento y consultoría.</li>
                                <li>Capacitación.</li>
                                <li>Contratación, Comercialización y procesamiento de datos.</li>
                            </ul>
                        </h3>
                    </div>
                ...
                <div class="row text-center">
                    <div class="col-md-4">
                        <span class="">
                            <img src="{{asset('assets/img/iconos/1.png')}}" alt="">
                        </span>
                        <h4 class="my-3">Conocimiento</h4>
                        <p class="text-muted">Contamos con equipo multidisciplinario capaz de lidiar con las diferentes problemáticas que se puedan presentar durante el desempeño de sus funciones</p>
                    </div>
                    <div class="col-md-4">
                        <span class="">
                            <img src="{{asset('assets/img/iconos/2.png')}}" alt="">
                        </span>
                        <h4 class="my-3">Experiencia</h4>
                        <p class="text-muted">A lo largo de los años hemos acumulado la expericiencia necesaria según avanzaba la tecnología para desempeñarnos de la forma más eficaz.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="">
                            <img src="{{asset('assets/img/iconos/3.png')}}" alt="">
                        </span>
                        <h4 class="my-3">Atención Diferenciada</h4>
                        <p class="text-muted">Trabajamos de conjunto con el cliente para obtener una mejor solución para su negocio. Ofrecemos una comuncación constante y una atención especial</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-start">Copyright &copy; Edessi 2022</div>
